...
export function createLoomSummaryButton() {
  ...
  // Create button using DOMUtils for proper DOM insertion
  const button = DOMUtils.createElement("button", {
    attrs: {
      id: "lumia-loom-summary-btn",
      class: "lumia-loom-summary-btn",
      title: "View/Edit Loom Summary",
    },
    html: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  // Attach click handler using native DOM
