...
import { getSettings, MODULE_NAME, LOOM_SUMMARY_KEY } from './settingsManager.js';
 ...
 * @returns {Promise<string>} The generated summary
 */
export async function generateSummaryWithSecondaryLLM(sumSettings, messageContext) {
 ...
 */
export async function generateLoomSummary(overrideSettings = null, isManual = false) {
